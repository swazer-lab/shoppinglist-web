...
const PrivacyPolicy = () => {
	useDocumentTitle(language.titlePrivacyPolicy);

	return(
	<div className='services'>
		<h2>{language.titlePrivacyPolicy}</h2>

		<p>Your privacy is important to us. It is Swazerlab's policy to respect your privacy regarding any information
			we may collect from you across our website, <a
				href="http://shoppingweb.swazerlab.com">http://shoppingweb.swazerlab.com</a>, and other sites we own and
			operate.</p>
